      ...
      <div className="w-[10vw] h-[95vh] border-r border-slate-100 shadow-2xl flex flex-col ">
        <div className="h-[85vh]  m-auto">
          ...
          <Link href="/adminpage/products">
            <div className="flex cursor-pointer  m-auto pt-3 pl-2 bg-[rgb(0,0,128)] text-white h-12 w-32 rounded-md mt-3">
              <BusinessCenterIcon />
              Products
            </div>
          </Link>
          <Link href="/adminpage/categories">
            <div className="flex  m-auto pt-3 bg-[rgb(0,0,128)] pl-2 text-white h-12 w-32 rounded-md mt-3">
              <CategoryIcon />
              Categories
            </div>
          </Link>
